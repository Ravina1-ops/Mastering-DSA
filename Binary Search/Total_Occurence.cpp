...
int main(){
    ...
    int total = (lastoccurence(arr,5,2) - firstoccurence(arr,5,2))+ 1;
    ...
    cout<<"last occurence is: "<<lastoccurence(arr2,15,18)<<endl;
     int total2 = (lastoccurence(arr2,15,18) - firstoccurence(arr2,15,18))+ 1;
    cout<<"Total occurence: "<<total2<<endl;
    ...
    cout<<"last occurence is: "<<lastoccurence(arr3,10,7)<<endl;
     int total3 = (lastoccurence(arr3,10,7) - firstoccurence(arr3,10,7))+ 1;
    cout<<"Total occurence: "<<total3<<endl;
    ...
    cout<<"last occurence is: "<<lastoccurence(arr4,9,4)<<endl;
     int total4 = (lastoccurence(arr4,9,4) - firstoccurence(arr4,9,4))+ 1;
    cout<<"Total occurence: "<<total4<<endl;
}